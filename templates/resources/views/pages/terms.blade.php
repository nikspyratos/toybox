...
<section class="primary-section">
    <div class="px-4 pt-8 pb-4 mx-auto w-3/4 max-w-screen-xl lg:pt-24">
        ...
        <p class="text-gray-400">Last updated: current_date</p>
        ...
        <div>
            ...
            <p>If you have a question about any of these Terms, please <a href="mailto:{{ config('app.contact-email') }}">contact us</a>.</p>
        </div>
    </div>
</section>
@endsection
