...
class SocialstreamRegistrationTest extends TestCase
{
     ...
     * @test
     */
    public function users_get_redirected_correctly(string $provider): void
    {
     ...
     * @test
     */
    public function users_can_register_using_socialite_providers(string $socialiteProvider)
    {
