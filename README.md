...
- **GDPR-Compliant Cookie Consent**: By default, Toybox will only use necessary cookies for session data. The cookie banner will be built with this in mind - if you add marketing/personalisation/analytics related cookies, you'll need to change this. See the [recommended providers](resources/markdown/documentation_pages/recommendations.md) to avoid issues. 
