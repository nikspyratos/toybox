    ...
    <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <a href="{{ route('register') }}" class="text-white bg-matisse-500 hover:bg-matisse-800 focus:ring-4 focus:ring-matisse-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-matisse-600 dark:hover:bg-matisse-500 focus:outline-none dark:focus:ring-matisse-800">Sign Up</a>
