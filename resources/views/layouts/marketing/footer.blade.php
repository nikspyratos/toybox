<footer class="bg-white dark:bg-gray-900 bg-dots-darker dark:bg-dots-lighter">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center mt-5 space-x-5">
                    ...
                    <a class="text-center text-sm text-matisse-500 dark:text-matisse-400 sm:text-left" href="https://nikspyratos.com">
                        <x-heroicon-o-link
