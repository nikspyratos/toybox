...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900 bg-dots-darker dark:bg-dots-lighter">
        <div class="grid px-4 pt-20 pb-8 mx-auto max-w-screen-xl lg:grid-cols-12 lg:gap-8 lg:py-16 lg:pt-28 xl:gap-0">
            <div class="place-self-center mr-auto lg:col-span-7">
                <h1 class="mb-6 max-w-2xl text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">A TALL starter kit for <br>Laravel solopreneurs.</h1>
                <p class="mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-4 lg:text-xl dark:text-gray-300">The Toybox has a bit of everything - a grand tour of the Laravel PHP world, so to speak. Let's have some fun!</p>
                ...
                <p class="mb-6 font-semibold text-gray-500 lg:mb-8 dark:text-gray-300">This landing page is both a template for your SaaS and an explainer of the Toybox project.</p>
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="https://github.com/nikspyratos/toybox" class="inline-flex justify-center items-center py-3 px-5 w-full text-sm font-medium text-center text-gray-900 bg-gray-100 rounded-lg border border-gray-200 sm:w-auto dark:border-gray-700 hover:bg-gray-200 focus:ring-4 focus:ring-gray-100 dark:hover:bg-gray-500 dark:focus:ring-gray-800">
            ...
            <div class="hidden lg:flex lg:col-span-5 lg:mt-0">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="px-4 pb-8 mx-auto max-w-screen-xl lg:pb-16">
            <p class="mb-6 text-center text-gray-500 dark:text-gray-300">Here's some logos, where you'd put your customers.</p>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="py-8 px-4 mx-auto space-y-12 max-w-screen-xl lg:py-24 lg:px-6 lg:space-y-20">
            <!-- Row -->
    ...
    <section class="bg-white dark:bg-gray-900 bg-dots-darker dark:bg-dots-lighter">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-24 lg:px-6">
            ...
            <div class="space-y-8 sm:gap-6 lg:grid lg:grid-cols-3 lg:space-y-0 xl:gap-10">
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow xl:p-8 dark:text-white dark:bg-gray-800 dark:border-gray-600">
                    ...
                    <a href="#" class="py-2.5 px-5 text-sm font-medium text-center text-white bg-emerald-600 rounded-lg dark:text-white hover:bg-emerald-700 focus:ring-4 focus:ring-emerald-200 dark:focus:ring-emerald-900">Get started</a>
                </div>
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow xl:p-8 dark:text-white dark:bg-gray-800 dark:border-gray-600">
    ...
    <!-- Start block -->
    <section class="bg-white dark:bg-gray-900">
        <div class="px-4 pb-8 mx-auto max-w-screen-xl lg:px-6 lg:pb-24">
            ...
            <div class="bg-white dark:bg-gray-900" x-data="{ open: false }">
                <button @click="open = !open" type="button" class="flex justify-between items-center py-5 w-full font-medium text-left text-gray-900 bg-white border-b border-gray-200 dark:text-white dark:bg-gray-900 dark:border-gray-700" :aria-expanded="open" aria-controls="accordion-flush-body-1">
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight leading-tight text-gray-900 dark:text-white">Start your free trial today</h2>
                <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-300">Just kidding. But here's another link to the docs.</p>
                <a href="https://github.com/nikspyratos/toybox" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white bg-emerald-700 rounded-lg dark:bg-emerald-600 hover:bg-emerald-800 focus:ring-4 focus:ring-emerald-300 focus:outline-none dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">Free trial for 30 days</a>
            </div>
        </div>
    </section>
    <section class="p-12 bg-white dark:bg-gray-900 bg-dots-darker dark:bg-dots-lighter">
        <h2 class="mb-8 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white">Documentation</h2>
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
            <a href="https://laravel.com/docs" class="flex p-6 bg-white via-transparent rounded-lg shadow-2xl transition-all scale-100 dark:bg-gradient-to-bl dark:ring-1 dark:ring-inset dark:shadow-none from-matisse-700/50 shadow-matisse-500/20 motion-safe:hover:scale-[1.01] duration-250 dark:bg-voodoo-800/50 dark:ring-white/5 focus:outline focus:outline-2 focus:outline-emerald-500">
                <div>
                    <img class="w-16 h-16" src="{{ asset('images/laravel-logo.svg') }}">

                    <h2 class="mt-6 text-xl font-semibold dark:text-emerald-400 text-matisse-900">Laravel Documentation</h2>

                    <p class="mt-4 text-sm leading-relaxed text-matisse-500 dark:text-matisse-400">
                        Laravel has wonderful documentation covering every aspect of the framework. Whether you are a newcomer or have prior experience with Laravel, we recommend reading our documentation from beginning to end.
                    </p>
                </div>

                <x-heroicon-o-arrow-right class="self-center mx-6 w-6 h-6 shrink-0 stroke-emerald-500"></x-heroicon-o-arrow-right>
            </a>

            <a href="https://filamentphp.com/" class="flex p-6 bg-white via-transparent rounded-lg shadow-2xl transition-all scale-100 dark:bg-gradient-to-bl dark:ring-1 dark:ring-inset dark:shadow-none from-matisse-700/50 shadow-matisse-500/20 motion-safe:hover:scale-[1.01] duration-250 dark:bg-voodoo-800/50 dark:ring-white/5 focus:outline focus:outline-2 focus:outline-emerald-500">
                <div>
                    <img class="w-auto h-16" src="{{ asset('images/filament-logo.png') }}">

                    <h2 class="mt-6 text-xl font-semibold dark:text-emerald-400 text-matisse-900">Filament</h2>
            ...
            <a href="https://laravel.com/docs/master/starter-kits#laravel-breeze" class="flex p-6 bg-white via-transparent rounded-lg shadow-2xl transition-all scale-100 dark:bg-gradient-to-bl dark:ring-1 dark:ring-inset dark:shadow-none from-matisse-700/50 shadow-matisse-500/20 motion-safe:hover:scale-[1.01] duration-250 dark:bg-voodoo-800/50 dark:ring-white/5 focus:outline focus:outline-2 focus:outline-emerald-500">
                <div>
                    <img class="w-16 h-16" src="{{ asset('images/breeze-logo-icon.png') }}">

                    <h2 class="mt-6 text-xl font-semibold dark:text-emerald-400 text-matisse-900">Breeze</h2>
            ...
            <a href="https://github.com/nikspyratos/toybox" class="flex p-6 bg-white via-transparent rounded-lg shadow-2xl transition-all scale-100 dark:bg-gradient-to-bl dark:ring-1 dark:ring-inset dark:shadow-none from-matisse-700/50 shadow-matisse-500/20 motion-safe:hover:scale-[1.01] duration-250 dark:bg-voodoo-800/50 dark:ring-white/5 focus:outline focus:outline-2 focus:outline-emerald-500">
                <div>
                    <img class="w-16 h-16" src="{{ asset('images/toybox-logo.png') }}">

                    <h2 class="mt-6 text-xl font-semibold dark:text-emerald-400 text-matisse-900">Next Steps</h2>
