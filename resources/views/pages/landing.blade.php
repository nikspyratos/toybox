    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="mb-6 lg:mb-8 font-light text-gray-500">This page was built using the <a class="underline text-matisse-500" href="https://demo.themesberg.com/landwind/">Landwind theme</a>. It's part demo, part explainer.</p>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <span>This is where a hero image would go...</span>
            </div>
        </div>
    </section>
    {{--  Logos  --}}
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <span>Insert a feature image here...</span>
            </div>
            <!-- Row -->
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <span>Insert a feature image here...</span>
