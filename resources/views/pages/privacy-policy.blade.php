...
<section class="primary-section">
    <div class="px-4 pt-8 pb-4 mx-auto w-3/4 max-w-screen-xl lg:pt-24">
        ...
        <div>
            ...
            <p>Have any questions, comments, or concerns about this privacy policy, your data, or your rights with respect to your information? Please get in touch by <a href="{{ route('contact-us') }}">contacting us</a> and we’ll be happy to try to answer them!</p>
        </div>
    </div>
</section>
@endsection
